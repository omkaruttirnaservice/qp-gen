...
function QuestionsListAutoTest() {
    ...
    const getTopicAndQuestionCount = (subjectId) => {
        ...
        sendRequest(reqData, ({ data }) => {
            ...
            const isSubjectAlreadyAddedToTestChart = selectedTopicList.findIndex(
                (item1) => item1._subjectName == currentSubjectName
            );
            ...
            <InfoContainer>
                <div className="grid grid-cols-2 mb-4">
                    ...
                    {_formData.subject_id && (
                        <CButton
                            icon={<BiReset />}
                            className={'btn--danger w-fit justify-self-end h-fit self-end mb-1'}
